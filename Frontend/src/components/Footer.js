...
const Footer = () => (
  <footer className="w-full bg-black text-white py-10 px-4 flex flex-col md:flex-row items-center justify-between shadow-2xl border-t border-gray-800">
    <div className="flex items-center gap-4 mb-6 md:mb-0">
      <svg width="48" height="48" viewBox="0 0 24 24" className="drop-shadow-lg">
        ...
        <path d="M12 2L15 8H9L12 2ZM12 22L9 16H15L12 22ZM2 12L8 15V9L2 12ZM22 12L16 9V15L22 12Z" fill="url(#gradient)"/>
        <defs>
      ...
      <div>
        <span className="text-2xl font-extrabold tracking-wide">CodeSync</span>
        <div className="text-xs text-gray-400">Empowering Future Collaboration &copy; 2025</div>
      </div>
    </div>
    <div className="flex gap-6">
      <a
        ...
        aria-label="Twitter"
      >
        <svg width="28" height="28" viewBox="0 0 24 24" className="fill-gray-400 hover:fill-cyan-500 transition-colors">
