  ...
  return (
    <div
      ...
      <Lid
        ...
        rotate={rotate}
        translate={translate} />
      {/* Base area - updated color */}
      <div
        className="relative -z-10 h-[22rem] w-[32rem] overflow-hidden rounded-2xl bg-[#8c8c8c] dark:bg-[#727272]">
        {/* above keyboard bar */}
  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="relative h-[12rem] w-[32rem] rounded-2xl bg-[#8c8c8c] p-2">
        <div
          style={{
      ...
      <motion.div
        ...
        className="absolute inset-0 h-96 w-[32rem] rounded-2xl bg-[#8c8c8c] p-2">
